...
const MaxFibra = () => {
    const sections = [
        ...
        //PROGRAMA ANALISE E MONITORAMENTO  =================
        {
            ...
            links: [
            { url: 'https://grupomaxltda.smartolt.com/', imgSrc: 'https://maxfibraltda.com.br/wp-content/uploads/2024/05/SMART-OLT.png', altText: 'SMART-OLT', text: 'Smart-Olt', isEquipamentos: true,},
